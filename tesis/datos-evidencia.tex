...
% Modelo de consumo por estados con valores de ficha (analisis/modelo_consumo.py, Monte Carlo N=50000).
\newcommand{\AutonomiaFichaMediana}{47~días}
\newcommand{\AutonomiaFichaRango}{42--54~días}
\newcommand{\CorrienteFichaMediana}{0.82~mA}
\newcommand{\CorrienteFichaRango}{0.73--0.91~mA}
\newcommand{\IncertidumbreTipoB}{1.0~\textdegree C}
% Deposito Zenodo del repositorio (22 de septiembre de 2026): DOI de concepto y de la version v1.0-tesis.
\newcommand{\DOIZenodo}{10.5281/zenodo.22903028}
\newcommand{\DOIZenodoVuno}{10.5281/zenodo.22903029}
