...
Las redes de sensores inalámbricos permiten distribuir puntos de medición sin instalar cableado de comunicación en cada ubicación \cite{akyildiz2002,yick2008,mois2017}. Para aplicaciones de baja tasa de datos, LoRa ofrece una alternativa de largo alcance y bajo consumo adecuada para nodos alimentados por batería, cuyo alcance y escalabilidad se han caracterizado experimentalmente \cite{centenaro2016,semtech2015,augustin2016,bor2016}. Diversos trabajos han empleado LoRa para el monitoreo de temperatura y de condición en entornos industriales y de infraestructura \cite{polonelli2019,jakobsen2024}. Estas soluciones se enmarcan en el mantenimiento predictivo de la Industria 4.0, donde el seguimiento continuo de variables como la temperatura permite anticipar fallas \cite{cinar2020,jardine2006}. Estas características se aprovecharon en SmartSense Monitoring para construir una plataforma local, modular y configurable.
