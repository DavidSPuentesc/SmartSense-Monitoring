...
Para estimar la autonomía se realizó una prueba de descarga con una batería de \SI{1000}{\milli\ampere\hour}, registrando el voltaje del nodo en operación normal. Entre el 13 y el 18 de agosto de 2026 (\SI{120}{\hour}) el voltaje descendió de \SI{4.112}{\volt} a \SI{4.089}{\volt}, es decir una tasa de \SI{0.19}{\milli\volt\per\hour} (Fig.~\ref{fig:autonomia-descarga}). Extrapolando linealmente hasta el voltaje de corte de \SI{3.30}{\volt}, la autonomía estimada es de aproximadamente \num{177} días (\num{5.9} meses); hasta \SI{3.00}{\volt}, unos \num{242} días. Como la extrapolación parte de la zona alta de la curva del LiPo ---donde el voltaje cae más rápido que en la meseta central---, este valor constituye una cota inferior conservadora.

La corriente promedio implicada es de \SI{0.24}{\milli\ampere}. La Fig.~\ref{fig:autonomia-ciclo} muestra el modelo de consumo por ciclo: el nodo permanece en sueño profundo (\SI{\approx 15}{\micro\ampere}) durante el \SI{98.1}{\percent} del tiempo y presenta un pico activo de \SI{2.279}{\second} ---arranque, lectura y transmisión LoRa--- con una corriente media cercana a \SI{12}{\milli\ampere}. Ambos enfoques ---la descarga medida y el modelo de ciclo de trabajo--- coinciden y confirman una autonomía del orden de meses, muy por encima del criterio de \SI{8}{\hour}. Con la batería de \SI{2000}{\milli\ampere\hour} del prototipo, la autonomía se duplicaría, del orden de un año.

\begin{figure}[!t]
  \centering
  \includegraphics[width=\columnwidth]{autonomia-descarga.pdf}
  \caption{Prueba de descarga de la batería de \SI{1000}{\milli\ampere\hour}: voltaje medido (13--18 de agosto de 2026) y extrapolación lineal hasta los voltajes de corte.}
