...
Dado este bajo ciclo de trabajo, el nodo permanece en sueño profundo el \SI{98.1}{\percent} del tiempo. Con las corrientes típicas de un ESP32-C6 en estado activo (decenas de mA) y en sueño profundo (del orden de decenas de \si{\micro\ampere}), la corriente promedio resultante es del orden de fracciones de \si{\milli\ampere}, lo que implica una autonomía estimada del orden de meses con la batería de \SI{2000}{\milli\ampere\hour}, muy por encima del criterio de \SI{8}{\hour}. Este resultado se presenta como estimación de orden de magnitud; la medición directa de la corriente activa y en reposo queda pendiente para confirmar el valor cuantitativo.
...
La disponibilidad del enlace, la pérdida de paquetes, el error respecto a la referencia y la recuperación tras reinicio ya se documentaron. Como trabajo siguiente se medirá la corriente para confirmar la autonomía estimada, se confirmará el PDR con el contador de secuencia incorporado al firmware, se caracterizará la exactitud con un patrón de contacto calibrado, se medirá la latencia extremo a extremo mediante sincronización de reloj, se habilitará el RSSI y se completará la exportación directa de datos.
